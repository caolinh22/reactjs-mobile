...
const initPagination = { limit: 5, skip: 0 } // số item trả lại trong 1 lần gọi API 
          ...
          <div class="col-lg-12 col-md-12 col-sm-12">
            ...
            >
              ...
              <div class="form-group">
                ...
                />
                {errors.email && <p className='error-message'>Your email is required</p>}
              </div>
              ...
              <div class="form-group">
                ...
                />
                {errors.content && <p className='error-message'>Your email is required</p>}
              </div>
              <button
                type="submit"
                name="sbm"
